	...
	<body>
		...
		<ul class="dorm-book mt3">
			...
			<li>
		        ...
		        <span class="info-middle"><?=$v['name']?></span>
			</li>
			<li>
				<span class="book-tit">身份证号</span>
		        <span class="info-middle"><?=$v['card']?></span>
			</li>
			<li>
				<span class="book-tit">考生号</span>
		    <span class="info-middle"><?=$v['num']?></span>
			</li>
			<li>
				<span class="book-tit">学院</span>
		        <span class="info-middle"><?=$v['collect']?></span>
			</li>
			<li>
				<span class="book-tit">专业</span>
		        <span class="info-middle"><?=$v['major']?></span>
			</li>
			<li>
				<span class="book-tit">宿舍号</span>
		        <span class="info-middle"><?=$v['home']?></span>
			</li>
			<li>
				<span class="book-tit">铺位</span>
		        <span class="info-middle"><?=$v['bed']?></span>
			</li>
		</ul>
		<ul class="dorm-book mt3">
			<li class="basic-tit">
